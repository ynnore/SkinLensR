...
import { LanguageCode } from './LanguageSpinner'; // Assurez-vous d'importer depuis là où vous définissez LanguageCode

export type LanguageCode = 'en' | 'fr' | 'mi'; // Définir LanguageCode ici si ce n'est pas déjà fait.
