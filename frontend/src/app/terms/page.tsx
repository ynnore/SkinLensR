  ...
  return (
    ...
    >
      ...
      <section className={styles.section}>
        ...
        <p className={styles.sectionText}>
         Bienvenue chez Kiwi-Ops ! La présente Directive d'Utilisation des Services (« Directive ») décrit les conditions selon lesquelles Kiwi-Ops, ci-après dénommé « Nous » ou « Kiwi-Ops », propose l'accès et l'utilisation de ses services, plateformes et contenus, ci-après dénommés collectivement les « Services ». En accédant ou en utilisant nos Services, vous (« l'Utilisateur ») acceptez d'être lié par les termes et conditions énoncés ci-dessous. Veuillez lire attentivement cette Directive.
        </p>
        <p className={styles.sectionText}>
