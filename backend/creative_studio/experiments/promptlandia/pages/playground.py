...
"""This module defines the playground page of the application.

It includes the UI components for the playground page, as well as the logic for
handling user input, adjusting model parameters, and interacting with the
generative AI model.
"""
...
@me.stateclass
class PageState:
    """Local page state for the playground page."""
...
def playground_page_content(app_state: me.state):
    """Renders the main content of the playground page.
    ...
    with me.box(style=_STYLE_CONTAINER):
        ...
        with me.box(style=_STYLE_MAIN_COLUMN):
            ...
            # Response Tab
            with tab_box(header="Response", key="response_tab"):  # pylint: disable=not-context-manager
                if state.response:
