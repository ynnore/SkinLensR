...
from app.embeddings import get_embedding, get_llm_response # <-- Assurez-vous que get_llm_response est importé
...
# ==============================================================================
# ROUTES POUR LA GESTION DES DOCUMENTS D'AGENT (RAG) - SANS CHROMA DB
# ==============================================================================
